    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        if(sender instanceof Player){
            ...
            if(player.hasPermission("squidmc.setlocation")){
                ...
                LocationManager.setLocation(LOCATIONTYPE.LOBBY, playerLocation);
                Text.sendTextToPlayerWithSound(player, Text.PREFIX+"Location §eLOBBY §7gesetzt!", Sound.BLOCK_NOTE_BLOCK_PLING);
            }else{
